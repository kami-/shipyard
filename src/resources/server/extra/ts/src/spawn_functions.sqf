...
ts_spawn_fnc_activateLocationMarker = {
    ts_spawn_selectedLocationMarkerName setMarkerAlpha 1;
    ts_spawn_selectedLocationMarkerName setMarkerBrush "Border";
    ts_spawn_selectedLocationMarkerName setMarkerColor "ColorGreen";
};
